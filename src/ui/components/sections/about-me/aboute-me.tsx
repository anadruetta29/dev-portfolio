...
import heroImg from "../../../assets/icons/computer-and-people.svg";
...
export default function AbouteMeSection({ id }: Props) {
    return (
        <section id={id} className={style.container}>
            <FadeIn delay={0}>
                <div className={style.illustrationSide}>
                    <img src={heroImg} alt="" />
                </div>
            </FadeIn>
            <div className={style.informationSide}>
                <FadeIn delay={0}>
                    <div className={style.titleInformation}>
                        ...
                        <div className={style.heroTitle}>
                            <LargeTitle text="Hola! Soy " />
                            <span className={style.nameHighlight}>Ana</span>
                        </div>
                    </div>
                </FadeIn>
                <FadeIn delay={0.4}>
                ...
                <FadeIn delay={0.6}>
                    <div className={style.informationButtons}>
                        <MainIconButton 
                            ...
                            enabled={true}
                            icon={githubIcon}
                            onClick={() => window.open("https://github.com/anadruetta29", "_blank")}
                        />
                        <MainIconButton 
                            text="Ver currículum"
                            type="button"
                            enabled={true}
                            icon={docIcon}
                            onClick={() => window.open("/cv/CV - Ana Druetta.pdf", "_blank")}
                        />
                    </div>
                </FadeIn>
            </div>
